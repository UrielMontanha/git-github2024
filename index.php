...
<body>
    ...
    <fieldset> <legend> <h1> Lista de Usuarios </h1> </legend>
  ...
  <tr>
    <td>
    <?php
        $sql = "SELECT email FROM usuario WHERE email='2022315433@gmail.com'";
    $resultado = mysqli_query($conexao, $sql);
    $dados = mysqli_fetch_assoc($resultado);
    ...
    <td>
    <?php
        $sql = "SELECT senha FROM usuario WHERE email='2022315433@gmail.com'";
    $resultado = mysqli_query($conexao, $sql);
    $dados = mysqli_fetch_assoc($resultado);
